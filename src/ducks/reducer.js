...
function reducer(state=initialState, action){
  switch(action.type){
    ...
    case UPDATE_ADD_THREE:
      return Object.assign({}, state, {add_three: action.payload})
    case UPDATE_FIRST:
...
export function updateAddOne (add_one){
  return ({
    type: UPDATE_ADD_ONE,
    payload: add_one
  })
...
export function updateAddTwo (add_two){
  return ({
    type: UPDATE_ADD_TWO,
    payload: add_two
  })
...
export function updateAddThree (add_three){
  return ({
